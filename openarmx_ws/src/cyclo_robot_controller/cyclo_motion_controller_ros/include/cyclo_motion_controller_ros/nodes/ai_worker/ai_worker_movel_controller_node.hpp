...
#include <openarmx_scenario_player_msgs/msg/move_l.hpp>
...
private:
  ...
  rclcpp::Subscription<openarmx_scenario_player_msgs::msg::MoveL>::SharedPtr right_movel_sub_;
  rclcpp::Subscription<openarmx_scenario_player_msgs::msg::MoveL>::SharedPtr left_movel_sub_;
  ...
  void rightMoveLCallback(const openarmx_scenario_player_msgs::msg::MoveL::SharedPtr msg);
  void leftMoveLCallback(const openarmx_scenario_player_msgs::msg::MoveL::SharedPtr msg);
