...
public:
    ...
    dragging_(false)
  {
    ...
    goal_pub_ = this->create_publisher<openarmx_scenario_player_msgs::msg::MoveL>(goal_topic_, 10);
...
private:
  ...
  {
    openarmx_scenario_player_msgs::msg::MoveL goal_msg;
  ...
  rclcpp::Publisher<openarmx_scenario_player_msgs::msg::MoveL>::SharedPtr goal_pub_;
